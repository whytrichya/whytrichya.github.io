...
<body>
  ...
  <nav class="navbar">
    ...
    <div class="navbar-extra">
      <a href="register.php" id=""><i data-feather="user"></i></a>
      <!-- <a href="#" id=""><span></span><i data-feather="shopping-cart"></i><a id="count">0</a></a> -->
    ...
    <div class="row">
      <?php foreach($result1 as $result1) : ?>
        <div class="row">
          ...
          <a href="login.php" class="button">add to cart</a>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
